...
+ (void)initialize
{
    ...
    [navBar setBarTintColor:[UIColor appMainColor]];
    ...
    [navBar setBackgroundImage:[UIImage imageWithColor:[UIColor appMainColor]] forBarPosition:UIBarPositionAny barMetrics:UIBarMetricsDefault];
